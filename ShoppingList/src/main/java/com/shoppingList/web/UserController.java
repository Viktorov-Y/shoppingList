...
import com.bookStore.model.binding.UserLoginBindingModel;
import com.bookStore.model.binding.UserRegisterBindingModel;
    ...
    public String registerConfirm(@Valid UserRegisterBindingModel userRegisterBindingModel
        ...
        if (bindingResult.hasErrors() || !userRegisterBindingModel.getPassword()
            ...
            redirectAttributes.addFlashAttribute(
                    ...
                    , bindingResult);
            redirectAttributes.addFlashAttribute("passwordMatch",
                    userRegisterBindingModel.getPassword().equals(userRegisterBindingModel.getConfirmPassword()));
            return "redirect:register";
        }
        boolean isSaved = userService.register(this.modelMapper.map(
